...
public class Depot9 extends LinearOpMode
{
    @Override
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d pickupSpike3 = new Pose2d(12,autoFun.redBlueT(-48),Math.toRadians(autoFun.redBlueT(initialRotation))); //-50
        ...
        Pose2d pickupSpike2 = new Pose2d(-12,autoFun.redBlueT(-48),Math.toRadians(autoFun.redBlueT(initialRotation))); //-50
