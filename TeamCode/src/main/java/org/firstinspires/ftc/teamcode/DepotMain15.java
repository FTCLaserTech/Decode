...
public class DepotMain15 extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d toInitialLaunchPosition = new Pose2d(14,autoFun.redBlueT(-20),Math.toRadians(autoFun.redBlueT(135))); // old position(12,-17)
        ...
        Pose2d nearGate = new Pose2d(-10,autoFun.redBlueT(-45),Math.toRadians(autoFun.redBlueT(initialRotation))); //-31
        ...
        Pose2d nearpickupgate = new Pose2d(-15,autoFun.redBlueT(-45),Math.toRadians(autoFun.redBlueT(initialRotation))); //-50
