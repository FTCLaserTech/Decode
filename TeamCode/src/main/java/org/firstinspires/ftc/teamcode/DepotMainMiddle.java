...
public class DepotMainMiddle extends LinearOpMode
{
    @Override
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d toSpike3 = new Pose2d(autoFun.redBlueT(-58.5),-42,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
        Pose2d pickupSpike3 = new Pose2d(autoFun.redBlueT(-58.5),-67,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
        Pose2d nearGate = new Pose2d(autoFun.redBlueT(-70),-55,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
        Pose2d toGate = new Pose2d(autoFun.redBlueT(-70),-70,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
        Pose2d toSpike2 = new Pose2d(autoFun.redBlueT(-82),-42,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
        Pose2d pickupSpike2 = new Pose2d(autoFun.redBlueT(-82),-67,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
        Pose2d toSpike1 = new Pose2d(autoFun.redBlueT(-106),-42,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
        Pose2d pickupSpike1 = new Pose2d(autoFun.redBlueT(-106),-67,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
        Pose2d park = new Pose2d(autoFun.redBlueT(-77),-80,Math.toRadians(autoFun.redBlueR(initialRotation,0)));
